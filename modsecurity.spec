...
#
# Source0 file verified with key 0xD286E022149F0F6E (modsecurity@owasp.org)
#
Name     : modsecurity
Version  : 3.0.12
Release  : 9
URL      : https://github.com/owasp-modsecurity/ModSecurity/releases/download/v3.0.12/modsecurity-v3.0.12.tar.gz
Source0  : https://github.com/owasp-modsecurity/ModSecurity/releases/download/v3.0.12/modsecurity-v3.0.12.tar.gz
Source1  : https://github.com/owasp-modsecurity/ModSecurity/releases/download/v3.0.12/modsecurity-v3.0.12.tar.gz.asc
...
%prep
%setup -q -n modsecurity-v3.0.12
cd %{_builddir}/modsecurity-v3.0.12
pushd ..
cp -a modsecurity-v3.0.12 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707785093
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libmodsecurity.so.3.0.12
/usr/lib64/libmodsecurity.so.3
/usr/lib64/libmodsecurity.so.3.0.12
