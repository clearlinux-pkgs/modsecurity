...
Version  : 3.0.6
Release  : 4
URL      : https://github.com/SpiderLabs/ModSecurity/releases/download/v3.0.6/modsecurity-v3.0.6.tar.gz
Source0  : https://github.com/SpiderLabs/ModSecurity/releases/download/v3.0.6/modsecurity-v3.0.6.tar.gz
Source1  : https://github.com/SpiderLabs/ModSecurity/releases/download/v3.0.6/modsecurity-v3.0.6.tar.gz.asc
...
%prep
%setup -q -n modsecurity-v3.0.6
cd %{_builddir}/modsecurity-v3.0.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652077011
...
cp %{_builddir}/modsecurity-v3.0.6/LICENSE %{buildroot}/usr/share/package-licenses/modsecurity/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
cp %{_builddir}/modsecurity-v3.0.6/others/libinjection/COPYING %{buildroot}/usr/share/package-licenses/modsecurity/2f52f7e673436d231eb560ccfc057715bc069c67
%make_install
...
/usr/lib64/libmodsecurity.so.3.0.6
